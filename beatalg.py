...
def getBPM(songName):#song as file
    ...
    maxfreq = 4096
    #Raul Facio - Look At Me When I Think Of You (Original Mix) (Techno)
    ...
    funcW = zeros((n,nbands),dtype=complex)
